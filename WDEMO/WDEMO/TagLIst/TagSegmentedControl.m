...
@interface TagSegmentedControl ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation TagSegmentedControl
...
-(void)addView{
    ...
    [self.collectionView registerClass:[TagListCell class] forCellWithReuseIdentifier:NSStringFromClass([TagListCell class])];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TagListCell *cell = (TagListCell *)[collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([TagListCell class]) forIndexPath:indexPath];
    cell.backgroundColor = [UIColor clearColor];
    
    cell.textHighlightColor = self.textHighlightColor;
    cell.textDefaultColor = self.textDefaultColor;
    cell.textHighBackgroundColor = self.textHighBackgroundColor;
