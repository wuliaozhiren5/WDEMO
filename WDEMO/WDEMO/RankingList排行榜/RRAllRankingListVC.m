...
@interface RRAllRankingListVC ()<UITableViewDelegate, UITableViewDataSource, scrollDelegate, WMPageControllerDelegate>
//tableview
...
- (WMPageController *)p_defaultController {
    ...
    RRAllRankingListSubVC *pageVC= [[RRAllRankingListSubVC alloc] initWithViewControllerClasses:viewControllers andTheirTitles:titles];
